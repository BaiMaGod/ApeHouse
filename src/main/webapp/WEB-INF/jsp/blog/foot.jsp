<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <div class="modal fade bd-example-modal-sm" id="gohome" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="" type="button" class="btn btn-primary" > 去瞧瞧 </a>
