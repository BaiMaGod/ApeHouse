...
<form action="">
    ...
    <div>
        <div id="title" >
            <input type="text" placeholder="输入文章标题" maxlength="64" required="required" value="${blog.title}">
    ...
    <div id="editor">
        ...
        <textarea style="display:none;" required="required"><jsp:include page="/ape/jsp/${blog.id}.jsp"></jsp:include></textarea>
    </div>
    <!-- Markdown 编辑器 -->
